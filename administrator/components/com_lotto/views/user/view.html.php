 ...
 * @since  1.6
 */
class LottoViewUser extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_LOTTO_TITLE_USER'), 'user.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			//JToolbarHelper::versions('com_lotto.user', $this->item->id);
		}
