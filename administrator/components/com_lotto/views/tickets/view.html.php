 ...
 * @since  1.6
 */
class LottoViewTickets extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		LottoHelper::addSubmenu('tickets');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_LOTTO_TITLE_TICKETS'), 'users.png');
		...
		if (file_exists($formPath))
		{
			...
			{
				// JToolBarHelper::editList('tickets.edit', 'JTOOLBAR_EDIT');
			}
		}
		...
		JHtmlSidebar::setAction('index.php?option=com_lotto&view=tickets');
	}
	...
	{
		return array(
			'a.`tickets_id`' => JText::_('JGRID_HEADING_ID'),
			'a.`user_id`' => JText::_('COM_LOTTO_TICKETS_USERS_ID'),
			'a.`tickets_tiraj_numbers`' => JText::_('COM_LOTTO_USERS_TICKETS_TIRAJ'),
			'a.`numbers`' => JText::_('COM_LOTTO_NUMBERS'),
			'a.`invoice_id`' => JText::_('COM_LOTTO_INVOICE_ID'),
			'a.`created_data`' => JText::_('COM_LOTTO_CREATED_DATE'),
		);
	}
