 ...
 * @since  1.6
 */
class LottoModelUser extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_lotto.user';
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_lotto.edit.user.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__lotto_users');
				$max             = $db->loadResult();
	 ...
	 public function update_balace($deducted_amount,$user_id ){
        ...
        $deducted_amount = $balance + $deducted_amount;
