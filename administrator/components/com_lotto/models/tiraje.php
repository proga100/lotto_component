 ...
 * @since  1.6
 */
class LottoModelTiraje extends JModelList
{
...
/**
	...
	*/
	...
	public function getAlltirage()
	{
        ...
        $query
            ->select('*')
            ->from($db->quoteName('#__lotto_tiraje'));
     ...
     * @return mixed Array of data items on success, false on failure.
     */
    public function getTirajeInfo($tirajenumber)
    {
        // Get a db connection.
        $db = JFactory::getDbo();
...
// Load the results as a list of stdClass objects (see later for more options on retrieving data).
    ...
    public function getTirajeInfobyID($tirajid)
    {
        // Get a db connection.
        $db = JFactory::getDbo();
...
// Order it by the ordering field.
        ...
        $query->where($db->quoteName('id') . ' = '. $db->quote($tirajid));
