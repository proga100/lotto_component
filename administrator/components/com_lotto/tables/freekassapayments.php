 ...
 * @since  1.6
 */
class LottoTableFreekassapayments extends JTable
{
	/**
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'LottoTableFreekassapayments', array('typeAlias' => 'com_lotto.freekassapayments'));
		parent::__construct('#__lotto_freekassapayments', 'id', $db);
	}
