 ...
 * @since  1.6
 */
class LottoTableWinningnumbers extends JTable
{
	/**
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'LottoTableWinningnumbers', array('typeAlias' => 'com_lotto.winningnumbers'));
		parent::__construct('#__lotto_winning_numbers', 'id', $db);
	}
